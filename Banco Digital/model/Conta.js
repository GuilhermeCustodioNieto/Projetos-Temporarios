...
class Conta {
  ...
  saque(valor, acesso) {
    if (acesso) {
      if (valor <= this.saldo) {
        ...
        return {
          saque: `Saque de ${valor} realizado com sucesso, seu saldo atual é ${this.saldo}`,
        };
      } else {
  ...
  depositar(valor, acesso) {
    if (acesso) {
      this.saldo = this.saldo + valor;
      return {
        deposito: `Realizado deposito de ${valor} com sucesso, seu saldo atual é ${this.saldo}`,
      };
    } else {
